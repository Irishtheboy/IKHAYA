          ...
          <div className="p-8">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2">
                ...
                {/* Description */}
                <div className="mb-8">
                  <h2 className="text-xl font-light text-slate-900 mb-4 tracking-tight">
                    DESCRIPTION
                  </h2>
                  ...
                  <div className="bg-slate-50 rounded-lg p-6 border border-slate-200">
                    <dl className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <dd className="mt-1 text-sm text-slate-900 capitalize font-light">
              ...
              <div className="lg:col-span-1">
                <div className="bg-slate-50 rounded-lg p-6 sticky top-4 border border-slate-200">
                  ...
                  <div className="border-t border-slate-200 pt-6">
                    <h3 className="text-sm font-light text-slate-900 mb-4 tracking-wide">
                  ...
                  <div className="border-t border-slate-200 pt-6 mt-6">
                    <p className="text-xs text-slate-500 text-center font-light mb-3">
                      SHARE THIS PROPERTY
                    </p>
                  ...
                  <div className="border-t pt-6 mt-6">
                    <div className="text-center">
                      ...
                      >
                        ...
                        {showContactNumber && landlord?.phone
                          ? landlord.phone
                          : 'Show Contact Number'}
                      </button>
                    </div>
