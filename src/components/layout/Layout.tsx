          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <div className="hidden md:ml-10 md:flex md:space-x-8">
                <Link to="/search" className="text-gray-700 hover:text-indigo-600 px-3 py-2 text-sm font-medium">
                  Search Properties
                </Link>
                {currentUser && userProfile?.role === 'landlord' && (
                  <>
                    <Link to="/properties/manage" className="text-gray-700 hover:text-indigo-600 px-3 py-2 text-sm font-medium">
                      My Properties
                    </Link>
                    <Link to="/leads" className="text-gray-700 hover:text-indigo-600 px-3 py-2 text-sm font-medium">
                      Leads
                    </Link>
                  </>
                )}
                {currentUser && (
                  <>
                    <Link to="/leases" className="text-gray-700 hover:text-indigo-600 px-3 py-2 text-sm font-medium">
                      Leases
                    </Link>
                    <Link to="/maintenance" className="text-gray-700 hover:text-indigo-600 px-3 py-2 text-sm font-medium">
                      Maintenance
                    </Link>
                  </>
                )}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-400">Your trusted platform for property rentals in South Africa.</p>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-4">Quick Links</h3>
              <ul className="space-y-2">
                <li><Link to="/search" className="text-gray-400 hover:text-white">Search Properties</Link></li>
                <li><Link to="/register" className="text-gray-400 hover:text-white">List Your Property</Link></li>
